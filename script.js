...
const el = {
  ...
  noButton: qs("#no-button"), // Add this line to select the no button
...
el.noButton.addEventListener("mouseover", () => {
  // Use mouseover to trigger on hover
  ...
  el.noButton.style.position = "absolute"; // Ensure position is absolute for movement
